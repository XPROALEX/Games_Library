package com.alex.games.library.security.jwt;
...
public class JwtUtils {
	...
	@Value("${gamelibrary.app.jwtCookieName}")
	private String jwtCookieName;

	@Value("${gamelibrary.app.jwtSecret}")
	private String jwtSecret;

	@Value("${gamelibrary.app.jwtExpirationMs}")
	private int jwtExpirationMs;

	@Value("${gamelibrary.app.jwtRefreshCookieName}")
